(function(a, b) {
    ...
    i = function(a) {
        ...
        try {
            ...
            for (var b = 0; b < this.instance.length; b++) if (this.instance[b] == this.container) throw new Error("An instance is running");
            this.instance.push(this.container),
            this.setup()
        } catch(c) {
            this.status = -1,
            this.errorInfo = c.message
        }
    };
    i.prototype = {
        _default: {
        ...
        $E: function(a, b, c) {
            ...
            for (var f = 0,
            g = e.length; f < g; f++)(new RegExp("(?:^|\\s+)" + a + "(?:\\s+|$)")).test(e[f].className) && d.push(e[f]);
            return d
        },
        isIE: function() {
            return ! - [1]
        ...
        css: function() {
            ...
            c = function(b, c) {
                var d;
                for (var e in c) d = a(e),
                typeof d == "string" ? b.style[d] = c[e] : d.set(b, c[e])
            };
            return function(a, d) {
        ...
        parse_args: function(a) {
            ...
            if (a && c.call(a) == "[object Object]") for (var d in this._default) b[d] = typeof a[d] == "undefined" ? this._default[d] : c.call(this._default[d]) == "[object Number]" ? parseInt(parseFloat(a[d]) * 100) / 100 : a[d];
        ...
        getMousePoint: function(b) {
            ...
            f = document.body;
            b || (b = a.event),
            a.pageYoffset ? (d = a.pageXOffset, y = a.pageYOffset) : (d = (e && e.scrollLeft || f && f.scrollLeft || 0) - (e && e.clientLeft || f && f.clientLeft || 0), y = (e && e.scrollTop || f && f.scrollTop || 0) - (e && e.clientTop || f && f.clientTop || 0));
        ...
        setup: function() {
            ...
            this.resize(),
            this.begin(),
            this.addListener(this.element, f, this.bind(this._start, this), !1),
            this.addListener(document, g, this.bind(this._move, this), !1),
            this.addListener(document, h, this.bind(this._end, this), !1),
            this.addListener(this.element, "webkitTransitionEnd", this.bind(this._transitionend, this), !1),
            this.addListener(this.element, "msTransitionEnd", this.bind(this._transitionend, this), !1),
            this.addListener(this.element, "oTransitionEnd", this.bind(this._transitionend, this), !1),
            this.addListener(this.element, "transitionend", this.bind(this._transitionend, this), !1),
            this.addListener(a, "resize", this.bind(function() {
                clearTimeout(this.resizeTimer),
                this.resizeTimer = setTimeout(this.bind(this.resize, this), 100)
            },
            this), !1),
            this.addListener(this.element, "mousewheel", this.bind(this.mouseScroll, this), !1),
            this.addListener(this.element, "DOMMouseScroll", this.bind(this.mouseScroll, this), !1)
        },
        resize: function() {
            var a;
            ...
            })) : (a.width = this.width * this.length + "px", a.left = -this.width * this.index + "px"),
            this.css(this.element, a);
        ...
        slideo: function(a, b) {
            ...
            a = a < 0 ? this.length - 1 : a >= this.length ? 0 : a,
            b = typeof b == "undefined" ? this.opt.speed: parseInt(b);
            var f = this.element,
            g = null,
            h = f.style,
            i = this,
            ...
            h.WebkitTransition = h.MozTransition = h.msTransition = h.OTransition = h.transition = c + " " + m * 10 + "ms " + this.opt.fx,
            this.opt.before.call(this, a, this.slides[this.index]),
            o()
        },
        begin: function() {
        ...
        next: function(a) {
            ...
            this.slideo((this.index + a) % this.length)
        },
        _start: function(a) {
            this.touching || this.preventDefault(a),
            this.element.onclick = null,
            this.startPos = this.getMousePoint(a);
        ...
        _end: function(a) {
            if (typeof this.scrolling != "undefined") {
                try {
                    ...
                    d = 0
                } (new Date - this.startTime < 250 && Math.abs(d) > this[c] * .1 || Math.abs(d) > this[c] / 2) && (d < 0 && this.index + 1 < this.length || d > 0 && this.index > 0) ? d > 0 ? this.prev() : this.next() : this.slideo(this.index),
                delete this.scrolling,
                delete this.startPos,
                delete this.endPos,
                delete this.startTime,
                this.opt.auto >= 0 && this.begin()
            }
        },
